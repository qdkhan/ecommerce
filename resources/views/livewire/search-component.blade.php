...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
            ...
            @else
                <p style="padding-top:30px;">No Product Found</p>
            @endif
                    ...
                    <ul class="list-category">
                        @foreach($categories as $category)
                            <li class="category-item">
                                <a href="{{route('product.category', ['category_id' => $category->id, 'category_name' =>$category->name])}}" class="cate-link" >{{$category->name}}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
